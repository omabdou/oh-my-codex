...
describe('teamCommand status', () => {
  it('prints pane ids and sparkshell hint when tmux panes are recorded', async () => {
    ...
    try {
      ...
      assert.match(output, /inspect_item_1: .*task_path=.*\/\.omx\/state\/team\/pane-team\/tasks\/task-1\.json .*approval_path=.*\/\.omx\/state\/team\/pane-team\/approvals\/task-1\.json .*worker_status_path=.*\/\.omx\/state\/team\/pane-team\/workers\/worker-1\/status\.json .*worker_heartbeat_path=.*\/\.omx\/state\/team\/pane-team\/workers\/worker-1\/heartbeat\.json .*worker_identity_path=.*\/\.omx\/state\/team\/pane-team\/workers\/worker-1\/identity\.json .*worker_inbox_path=.*\/\.omx\/state\/team\/pane-team\/workers\/worker-1\/inbox\.md .*team_config_path=.*\/\.omx\/state\/team\/pane-team\/config\.json .*team_manifest_path=.*\/\.omx\/state\/team\/pane-team\/manifest\.v2\.json .*command=omx sparkshell --tmux-pane %21 --tail-lines 400/);
      assert.match(output, /inspect_item_2: .*task_path=.*\/\.omx\/state\/team\/pane-team\/tasks\/task-2\.json .*approval_path=.*\/\.omx\/state\/team\/pane-team\/approvals\/task-2\.json .*worker_status_path=.*\/\.omx\/state\/team\/pane-team\/workers\/worker-2\/status\.json .*worker_heartbeat_path=.*\/\.omx\/state\/team\/pane-team\/workers\/worker-2\/heartbeat\.json .*worker_identity_path=.*\/\.omx\/state\/team\/pane-team\/workers\/worker-2\/identity\.json .*worker_inbox_path=.*\/\.omx\/state\/team\/pane-team\/workers\/worker-2\/inbox\.md .*team_config_path=.*\/\.omx\/state\/team\/pane-team\/config\.json .*team_manifest_path=.*\/\.omx\/state\/team\/pane-team\/manifest\.v2\.json .*command=omx sparkshell --tmux-pane %22 --tail-lines 400/);
